    ...
    stages {
        ...
        stage('Testing RDS Connection') {
            steps {
                ...
                script{
                    ROOTPW = sh(script: '''aws secretsmanager get-secret-value --secret-id /swms/deployment_automation/nonprod/oracle/master_creds/lx739q13 --region us-east-1''',returnStdout: true).trim()
                    echo "$ROOTPW"
                    TARGETDB='lx739q13'
