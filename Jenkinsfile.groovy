    ...
    post {
        success {
            script {
                ...
                sh "echo $EMAIL"
                emailext body: 'Project: $currentBuild.PROJECT_NAME <br/>Build # $currentBuild.BUILD_NUMBER <br/>Status: $currentBuild.currentResult <br/>Target Database ENV: ${params.TARGET_DB} <br/>Check console output at $BUILD_URL to view the results.',
                    mimeType: 'text/html',
